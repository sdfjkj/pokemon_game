    ...
    return (
        ...
        <div className="stars">
            ...
            <div className="box_astronaut">
                                <img className="object_astronaut" src="https://pokemon.itple.co.kr/public/img/pokemon/7.webp" width="140px"/>
                            </div>
            <img src="https://pokemon.itple.co.kr/public/img/pokemon/7.webp" className="astronaut1" />
